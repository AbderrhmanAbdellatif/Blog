                        ...
                        success: function (data) {
                            ...
                            if (categoryListDto.ResultStatus === 0) {
                                ...
                                $.each(categoryListDto.Categories.$values,
                                    ...
                                    <td>${category.Note}</td>
                                    <td>${convertToShortDate(category.CreateData)}</td>
                                    <td>${category.CreatedByName}</td>
                                    <td>${convertToShortDate(category.ModifedData)}</td>
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                                <tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                                                    ...
                                                    <td>${convertToShortDate(categoryAddAjaxModel.CategoryDto.Category.CreateData)}</td>
                                                    <td>${categoryAddAjaxModel.CategoryDto.Category.CreatedByName}</td>
                                                    <td>${convertToShortDate(categoryAddAjaxModel.CategoryDto.Category.ModifedData)}</td>
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                                <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
                                                    ...
                                                    <td>${convertToShortDate(categoryUpdateAjaxModel.CategoryDto.Category.CreateData)}</td>
                                                    <td>${categoryUpdateAjaxModel.CategoryDto.Category.CreatedByName}</td>
                                                    <td>${convertToShortDate(categoryUpdateAjaxModel.CategoryDto.Category.ModifedData)}</td>
