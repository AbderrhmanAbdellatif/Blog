            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7988),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7986),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7989),
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7994),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7992),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7995),
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7999),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7998),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(7999),
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8003),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8002),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8003),
                        ...
                        new
                        {
                            ...
                            Content = "Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz. Kökleri M.Ö. 45 tarihinden bu yana klasik Latin edebiyatına kadar uzanan 2000 yıllık bir geçmişi vardır. Virginia'daki Hampden-Sydney College'dan Latince profesörü Richard McClintock, bir Lorem Ipsum pasajında geçen ve anlaşılması en güç sözcüklerden biri olan 'consectetur' sözcüğünün klasik edebiyattaki örneklerini incelediğinde kesin bir kaynağa ulaşmıştır. Lorm Ipsum, Çiçero tarafından M.Ö. 45 tarihinde kaleme alınan \"de Finibus Bonorum et Malorum\" (İyi ve Kötünün Uç Sınırları) eserinin 1.10.32 ve 1.10.33 sayılı bölümlerinden gelmektedir. Bu kitap, ahlak kuramı üzerine bir tezdir ve Rönesans döneminde çok popüler olmuştur. Lorem Ipsum pasajının ilk satırı olan \"Lorem ipsum dolor sit amet\" 1.10.32 sayılı bölümdeki bir satırdan gelmektedir. 1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri ilgilenenler için yeniden üretilmiştir. Çiçero tarafından yazılan 1.10.32 ve 1.10.33 bölümleri de 1914 H. Rackham çevirisinden alınan İngilizce sürümleri eşliğinde özgün biçiminden yeniden üretilmiştir.",
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8007),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8006),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8008),
                            Note = "JAVA",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8012),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8011),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8013),
                            Note = "Python",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8016),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8015),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8017),
                            Note = "PHP",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8020),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8019),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8021),
                            Note = "Kotlin",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8025),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8024),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8026),
                            Note = "Swift",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8029),
                            Date = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8028),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(8030),
                            Note = "Ruby",
                            SeoAuthor = "Alper Tunga",
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9654),
                            Description = "C# Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9655),
                            Name = "C#",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9658),
                            Description = "C++ Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9659),
                            Name = "C++",
                            Note = "C++ Blog Kategorisi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9662),
                            Description = "JavaScript Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9662),
                            Name = "JavaScript",
                        ...
                        new
                        {
                            Id = 4,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9665),
                            Description = "Typescript Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9666),
                            Name = "Typescript",
                        ...
                        new
                        {
                            Id = 5,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9668),
                            Description = "Java Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9669),
                            Name = "Java",
                        ...
                        new
                        {
                            Id = 6,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9671),
                            Description = "Python Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9672),
                            Name = "Python",
                        ...
                        new
                        {
                            Id = 7,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9675),
                            Description = "Php Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9675),
                            Name = "Php",
                        ...
                        new
                        {
                            Id = 8,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9678),
                            Description = "Kotlin Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9678),
                            Name = "Kotlin",
                        ...
                        new
                        {
                            Id = 9,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9681),
                            Description = "Swift Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9682),
                            Name = "Swift",
                        ...
                        new
                        {
                            Id = 10,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9684),
                            Description = "Ruby Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 255, DateTimeKind.Local).AddTicks(9685),
                            Name = "Ruby",
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArticleId = 1,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2352),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2353),
                        ...
                        new
                        {
                            ...
                            ArticleId = 2,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2356),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2357),
                            Note = "C++ Makale Yorumu",
                        ...
                        new
                        {
                            ...
                            ArticleId = 3,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2360),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2361),
                        ...
                        new
                        {
                            ...
                            ArticleId = 4,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2363),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2364),
                        ...
                        new
                        {
                            ...
                            ArticleId = 5,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2367),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2367),
                        ...
                        new
                        {
                            ...
                            ArticleId = 6,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2370),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2371),
                        ...
                        new
                        {
                            ...
                            ArticleId = 7,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2373),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2374),
                        ...
                        new
                        {
                            ...
                            ArticleId = 8,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2376),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2377),
                        ...
                        new
                        {
                            ...
                            ArticleId = 9,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2379),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2380),
                        ...
                        new
                        {
                            ...
                            ArticleId = 10,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2383),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 6, 9, 18, 55, 20, 256, DateTimeKind.Local).AddTicks(2383),
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "3372e366-07f5-40d2-9816-64d0be8f0add",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "4fc10e18-e711-4b9a-8cac-7406b72bcb28",
                            Name = "Category.Read",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "3d8efcdb-799d-4300-b7bb-bf1a6f32d2f2",
                        ...
                        {
                            Id = 4,
                            ConcurrencyStamp = "82b9d377-3bef-4675-951d-7573a35e39d9",
                        ...
                        {
                            Id = 5,
                            ConcurrencyStamp = "63da23fc-603c-48bb-a154-b14a57f9979d",
                            Name = "Article.Create",
                        ...
                        {
                            Id = 6,
                            ConcurrencyStamp = "90890ff0-bd0d-45e7-83a8-0a84a5fcf4c2",
                            Name = "Article.Read",
                        ...
                        {
                            Id = 7,
                            ConcurrencyStamp = "6f5f58a5-76d5-49b3-9f17-cb95cc6d2d5d",
                            Name = "Article.Update",
                        ...
                        {
                            Id = 8,
                            ConcurrencyStamp = "33245778-0d0a-447e-b453-1ac3311f5fc8",
                            Name = "Article.Delete",
                        ...
                        {
                            Id = 9,
                            ConcurrencyStamp = "a6689a1b-43f4-451e-9f94-e13530fe6b14",
                            Name = "User.Create",
                        ...
                        {
                            Id = 10,
                            ConcurrencyStamp = "e4c9d0d5-9784-424e-b1a5-72b4fc7bb0ab",
                            Name = "User.Read",
                        ...
                        {
                            Id = 11,
                            ConcurrencyStamp = "6bad53bc-fe02-4ae3-9f9e-d97dad845d2e",
                            Name = "User.Update",
                        ...
                        {
                            Id = 12,
                            ConcurrencyStamp = "2ec4e49f-2420-4d0b-8214-3ffd0003c894",
                            Name = "User.Delete",
                        ...
                        {
                            Id = 13,
                            ConcurrencyStamp = "5c9be5a1-55b4-4497-ace0-9c925a0327d6",
                            Name = "Role.Create",
                        ...
                        {
                            Id = 14,
                            ConcurrencyStamp = "9fa6eaf4-da1a-4c8e-ae24-2fa120402bcf",
                            Name = "Role.Read",
                        ...
                        {
                            Id = 15,
                            ConcurrencyStamp = "d4fbe701-4b63-4978-bd51-67a8040bbec7",
                            Name = "Role.Update",
                        ...
                        {
                            Id = 16,
                            ConcurrencyStamp = "b9665140-64de-4357-9ec0-44893b32b3c9",
                            Name = "Role.Delete",
                        ...
                        {
                            Id = 17,
                            ConcurrencyStamp = "f0348d98-ca84-43bf-84d8-0fb7aa25c912",
                            Name = "Comment.Create",
                        ...
                        {
                            Id = 18,
                            ConcurrencyStamp = "9d41a442-6dae-44fd-897a-d556c3ca5f8f",
                            Name = "Comment.Read",
                        ...
                        {
                            Id = 19,
                            ConcurrencyStamp = "e6447854-431f-4c4e-a3ed-f3aef85df0fa",
                            Name = "Comment.Update",
                        ...
                        {
                            Id = 20,
                            ConcurrencyStamp = "fe829125-b227-486c-9d7a-4cea047cdcb5",
                            Name = "Comment.Delete",
                        ...
                        {
                            Id = 21,
                            ConcurrencyStamp = "721785df-ed51-4128-9095-752804ab88d7",
                        ...
                        {
                            Id = 22,
                            ConcurrencyStamp = "40a0b19a-7ac1-486b-99a5-de00de0729c6",
                            Name = "SuperAdmin",
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a20a8a61-6613-4a57-874f-f776d89e5a51",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEdSLGaPZjNAKxaPsTv3g8vsESVdtFROWqBtlZTXNieLg8GRm0II/Je+oHUVYlaOVA==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = true,
                            Picture = "/userImages/defaultUser.png",
                            SecurityStamp = "4571cff1-b6e4-45fe-a5dd-778abf815a17",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b00e6138-91ce-49a3-a311-ae484106feae",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBKE04/O0wd8rR2cMctCjp+7HaoN32Q451BfV3IAeDcKLh3Vw3C6E6AFjl8C8e1AHA==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = true,
                            Picture = "/userImages/defaultUser.png",
                            SecurityStamp = "5b5b782d-f211-4dd9-ae84-d18ede587388",
