    ...
    public class MailManager : IMailService
    {
        ...
        public IResult SendContactEmail(EmailSendDto emailSendDto)
        {
            MailMessage message = new MailMessage
            {
                ...
                To = { new MailAddress("taha196tr@gmail.com") }, //info@programmersblog.com
                Subject = emailSendDto.Subject,
                IsBodyHtml = true,
                Body = $"Gönderen Kişi: {emailSendDto.Name}, Gönderen E-Posta Adresi :{emailSendDto.Email}<br/>{emailSendDto.Message}<br/> Saygılarımla"
            };
            SmtpClient smtpClient = new SmtpClient
            {
                Host = _smtpSettings.Server,
